...
test.describe.serial('Data Verify and Add To Cart Tests', () => {
    ...
    test('Data Verify item', async () => {
        ...
        const InventoryItem0 = await page.locator(selectors.inventoryItem).first();
        ...
        const imageInventoryItem0 = await page.locator(selectors.inventoryItemImg).first();
        ...
        const InventoryItem1 = await page.locator(selectors.inventoryItem).nth(1);
        ...
        const InventoryItem2 = await page.locator(selectors.inventoryItem).nth(2);
        ...
        const InventoryItem3 = await page.locator(selectors.inventoryItem).nth(3);
        ...
        const InventoryItem4 = await page.locator(selectors.inventoryItem).nth(4);
        ...
        const InventoryItem5 = await page.locator(selectors.inventoryItem).nth(5);
    ...
    test('Verify Cart İtems Step', async () => {
    ...
    test('Finish Step - Checkout:Complete!', async () => {
