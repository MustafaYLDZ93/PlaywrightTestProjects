...
test.describe.serial('Data Verify and Add To Cart Tests', () => {
    ...
    test('Data Verify item', async () => {
        ...
        const InventoryItem0 = await page.locator(inventory_item).first();
        ...
        const InventoryItem2 = await page.locator(inventory_item).nth(2);
        ...
        const InventoryItem3 = await page.locator(inventory_item).nth(3);
        ...
        const InventoryItem4 = await page.locator(inventory_item).nth(4);
        ...
        const InventoryItem5 = await page.locator(inventory_item).nth(5);
